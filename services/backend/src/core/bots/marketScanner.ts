 ...
 * No live price/order-book feed exists in this codebase — "market
 * scanning" here means searchable-news-based signal detection only,
 * disclosed honestly in `description`, never fabricated live market data.
 */
...
export const marketScanner: BotDefinition = {
  id: "market-scanner",
  ...
  category: "market",
  scheduleCron: "*/30 * * * *",
  defaultConfig: { topics: ["crypto market", "stock market news", "new token listing", "IPO announcement"] },
